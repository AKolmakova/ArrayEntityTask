...
public class FlowersDomBuilderTest extends AbstractFlowersTestConfig {

    private FlowersDomBuilder flowersDomBuilder;

    @BeforeMethod
    public void setUp() throws ParseXmlException {
        flowersDomBuilder = new FlowersDomBuilder(CORRECT_RESOURCE_NAME, SCHEMA_NAME);
    }
    ...
    public void testGetFlowers(AbstractFlower expectedFlower) throws ParseXmlException {
        Set<AbstractFlower> flowers = flowersDomBuilder.buildFlowers();
